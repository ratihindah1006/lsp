...
@section('container')
    <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="data-table-list">
                            ...
                            <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modalTambahKodeSoalPraktik"><i
                                                      ...
                                                      <div id="header-bg_collapse{{ $loop->iteration }}" class="collapse accordion__body" data-parent="#accordion-seven">
                                                          <div class="accordion__body--text p-0">
                                                            <table class="table text-dark" border="solid black">
                                                                ...
                                                                @forelse ($schema->codes_praktik as $code)
                                                                <tr style="vertical-align:top">
                                                                    <td>{{ $loop->iteration }}</td>
                                                                    <td>{{ $code->code_praktik_name }}</td>
                                                                    <td class="text-center"><a href="/soalpraktik/kodesoal/{{ $code->id }}" class="btn btn-sm btn-primary"><span><i class="ti-search"></i></span></a></td>
                                                                </tr>
                                                                @empty
        ...
        <!-- Modal -->
        <form method="post" action="/soalpraktik/kodeSoal">
            @csrf
            <div class="modal fade" id="modalTambahKodeSoalPraktik">
