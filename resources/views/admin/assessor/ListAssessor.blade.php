            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        ...
                        <a href="/dataAssessor/create"class="btn btn-primary btn-sm"><i class="ti-plus ">&nbsp;&nbsp;&nbsp;</i>Add</a><br><br>
                            ...
                            <table class="display" id="example">
                                ...
                                @foreach ($assessor as $value)
                                    <tr>
                                        ...
                                        <td >
                    <a href="/dataAssessor/{{$value->id}}/edit" class="btn btn-warning btn-sm"><span class="ti-pencil"></span></a>
