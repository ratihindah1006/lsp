...
@section('container')
    <div class="container-fluid">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a
                            href="/category/{{ $category }}/schema/{{ $schema }}/unit/{{ $unit }}/element/{{ $element }}/criteria">
                            Kriteria</a></li>
                </ol>
            </div>
        </div>
        ...
        <div class="col-lg-7">
            <form method="post"
                action="/category/{{ $category }}/schema/{{ $schema }}/unit/{{ $unit }}/element/{{ $element }}/criteria">
                @csrf
                                        ...
                                        <div class="col-8">
                                            <div class="form-group row">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('criteria_title') }}" cols="40" rows="5">
                                        ...
                                        <div class="col">
                                            <div class="form-group row">
                                                <button type="submit" class="btn btn-primary mt-4"
                                                    style="width: 170px">Tambah</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <tbody>
                                                @foreach ($criteria as $value)
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            <a href="/category/{{ $category }}/schema/{{ $schema }}/unit/{{ $unit }}/element/{{ $element }}/criteria/{{ $value->id }}/edit"
                                                                class="btn btn-warning btn-sm"><span
                                                                    class="ti-pencil"></span></a>
                                                            <form
                                                                action="/category/{{ $category }}/schema/{{ $schema }}/unit/{{ $unit }}/element/{{ $element }}/criteria/{{ $value->id }}"
