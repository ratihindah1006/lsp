                            ...
                            <div class="row">
                              <div class="col-12">
                                <div class="form-group">
                                  ...
                                  <input name="category_code" type="text" class="form-control @error('category_code') is-invalid @enderror" id="category_code" value="{{ old('category_code', $category->category_code) }}">
                                  @error('category_code')
