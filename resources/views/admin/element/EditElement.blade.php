...
<div class="col-lg-8">
    <form method="post" action="/category/{{ $category->id }}/schema/{{ $schema->id }}/unit/{{ $unit->id }}/element/{{ $element->id }}">
        @method('put')
        @csrf
                        ...
                        <div class="card-content-center">
                            <div class="card-body">
                                ...
                                <div class="card-footer mb-3">
                                    ...
                                    <a href="/category/{{ $category->id }}/schema/{{ $schema->id }}/unit/{{ $unit->id }}/element" class="btn btn-outline-primary float-right mr-2">Batal</a>
                                </div>
                            </div>
                        </div>
                    </div>
