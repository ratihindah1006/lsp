            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        ...
                        <a href="/dashboard/create"class="btn btn-primary btn-sm"><i class="ti-plus">&nbsp;&nbsp;&nbsp;</i>Add</a><br><br>
                            ...
                            <table class="display" id="example">
                                ...
                                @foreach ($event as $value)
                                    <tr>
                                        ...
                                        <td>{{ $value->tipe }}</td>
                                        <td align="center">
                    <a href="'#'" class="btn btn-primary btn-sm"><span class="ti-info"></span></a>
                    <a href="/dashboard/{{ $value->id }}/edit" class="btn btn-warning btn-sm"><span class="ti-pencil></span></a>
