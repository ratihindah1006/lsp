...
@section('container')
    ...
    <div class="cards"><br><br>
        ...
        <p class="my-text">1. Mempelajari Kriteria Unjuk Kerja (KUK), Batasan Variabel, Panduan Penilaian, dan Aspek
            ...
            untuk di Ases.</p>
        <p class="my-text">2. Melaksanakan Penilaian Mandiri secara obyektif atas sejumlah pertanyaan yang diajukan,
        ...
        <p class="my-text">3. Mengisi bukti-bukti kompetensi yang relevan atas sejumlah pertanyaan yang dinyatakan
            Kompeten (bila ada).</p>
                    ...
                    @foreach ($unit->elements as $element)
                        <tr>
                            ...
                            <th>
                                ...
                                <div class="form-check">
                                    <input required class="form-check-input" type="radio"
                                        name="element_{{ $element->id }}" id="{{ $element->id }}" value="K"
                                        @if ($assessment && $assessment[$i] == 'K') checked @endif disabled>
                            ...
                            <th>
                                <br>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="element_{{ $element->id }}"
                                        id="{{ $element->id }}" value="BK"
                                        @if ($assessment && $assessment[$i] == 'BK') checked @endif disabled>
                                    <label class="form-check-label" for="{{ $element->id }}">
                                    </label>
                                    <?php $i++; ?>
                                </div>
            ...
            <table border="1" class="my-text">
                ...
                <tr>
                    <th rowspan="2">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="lane" id="lane" value="Uji Kompetensi">
                            <label class="form-check-label" for="lane">Uji Kompetensi</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="lane" id="lane" value="Asesmen Portofolio">
                            <label class="form-check-label" for="lane">Asesmen Portofolio</label>
                        </div>
                        </p>
                    </th>
                    <th>&ensp;Nama&ensp;</th>
                    <th>&ensp;{{ $assessi->name }}&ensp;</th>
                </tr>
