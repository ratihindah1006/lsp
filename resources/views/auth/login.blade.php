...
<body>
    ...
    <div class="limiter">
        <div class="container-login100" style="background:linear-gradient(to right, cyan, #4891e4,cyan);">
            <div class="wrap-login100 p-t-30 p-b-50">
                ...
                <form class="login100-form form-floating validate-form p-b-33 p-t-5" action="{{ route('postLogin') }}"
                    ...
                    <div class="wrap-input100 validate-input" for="email">
                        <input class="input100" id="email" name="email" type="text" placeholder="Masukkan email"
